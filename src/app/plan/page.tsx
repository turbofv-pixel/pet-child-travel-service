...
import type { CompanionType, Coordinates } from "@/types";
            ...
            {spots.length === 0 ? (
              ...
              <ul className="flex flex-col gap-3">
                {spots.map((spot) => (
                  <li
                    key={spot.id}
                    className="flex flex-col gap-1 rounded-xl border border-black/[.08] bg-white p-4 dark:border-white/[.145] dark:bg-zinc-950"
                  >
